...
find(const basic_value<C, M, V>& v, const key& ky, const key& ky2, Ts&& ... keys)
{
    return ::toml::find(::toml::find(v, ky), ky2, std::forward<Ts>(keys)...);
}
template<typename C,
         template<typename ...> class M, template<typename ...> class V,
         typename ... Ts>
basic_value<C, M, V>&
find(basic_value<C, M, V>& v, const key& ky, const key& ky2, Ts&& ... keys)
{
    return ::toml::find(::toml::find(v, ky), ky2, std::forward<Ts>(keys)...);
}
template<typename C,
...
find(basic_value<C, M, V>&& v, const key& ky, const key& ky2, Ts&& ... keys)
{
    return ::toml::find(::toml::find(std::move(v), ky), ky2, std::forward<Ts>(keys)...);
}
...
find(const basic_value<C, M, V>& v, const key& ky, const key& ky2, Ts&& ... keys)
{
    return ::toml::find<T>(::toml::find(v, ky), ky2, std::forward<Ts>(keys)...);
}
template<typename T, typename C,
         template<typename ...> class M, template<typename ...> class V,
         typename ... Ts>
...
find(basic_value<C, M, V>&& v, const key& ky, const key& ky2, Ts&& ... keys)
{
    return ::toml::find<T>(::toml::find(std::move(v), ky), ky2, std::forward<Ts>(keys)...);
}
